...
import { CustomComboSelect } from "@/components/custom-ui/custom-combo-select"
...
import { useSelectDataForCountries } from "@/hooks/constant-queries"
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <CustomComboSelect
                                                            buttonClass="flex w-[80px] h-full bg-gray-50 shadow-none placeholder:text-gray-500 rounded-tr-none rounded-br-none"
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="flex-1 w-full ">
                                                    ...
                                                    <FormControl>
                                                        <Input
                                                            className=" h-full bg-gray-50 shadow-none placeholder:text-gray-500 rounded-tl-none rounded-bl-none"
