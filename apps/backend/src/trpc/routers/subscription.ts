...
export const subscriptionRouter = createTRPCRouter({
    ...
    createPlanWithTranslation: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    updatePlanWithTranslation: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    getPlansWithPagination: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    getAllPlansForSelect: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
        .query(async ({ ctx }) => {
            return await subscriptionRepository.getAllPlansForSelect()
        }),

    getPlanById: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
        .input(z.object({ id: z.number() })).query(async ({ ctx, input }) => {
            return await subscriptionRepository.getPlanById(input.id)
        }),

    deletePlan: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    createSubscription: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    updateSubscription: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    getSubscriptionsWithPagination: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    deleteSubscription: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    createCampaignWithTranslation: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    updateCampaignWithTranslation: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    getCampaignsWithPagination: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    deleteCampaign: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    createCoupon: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    updateCoupon: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    getCouponsWithPagination: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    deleteCoupon: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
        .input(z.object({ id: z.number() })).mutation(async ({ input }) => {
    ...
    createUserDiscount: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    updateUserDiscount: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
    ...
    getAllUserDiscounts: protectedProcedure.use(roleMiddleware([SahredEnums.ROLE_MAP.ADMIN, SahredEnums.ROLE_MAP.OWNER]))
        .query(async ({ ctx }) => {
